...
namespace PhpLab\Sandbox\User\Api\Controller;

use PhpLab\Sandbox\User\Domain\Entity\User;
use PhpLab\Sandbox\User\Domain\Form\AuthForm;
use PhpLab\Sandbox\User\Domain\Service\AuthService;
