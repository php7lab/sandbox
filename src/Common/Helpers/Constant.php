...
class Constant {
    ...
    /*public static function setApplication($appName) {
        ...
        //defined('APP_TYPE') OR define('APP_TYPE', );
        //Yii::setAlias('@app', P_DIR);
    }

    /*public static function setProectDirectory($dir) {
        defined('PROJECT_DIR') OR define('PROJECT_DIR', realpath($dir));
    }
