...
class MenuWidget extends BaseWidget
{
    ...
    protected function renderItem($item)
    {
        if (isset($item['url'])) {
            ...
            if ($item['active']) {
                $params['class'] = $this->activeCssClass;
            }

            if ( ! empty($item['icon'])) {
                $params['icon'] = Html::tag('i', '', ['class' => $item['icon']]);
            }
            ...
            if (isset($item['badge'])) {
                ...
                $params['badge'] = Html::tag('span', $item['badge']['label'], ['class' => $badgeClasses]);
            }

            if ( ! empty($item['items'])) {
                $params['treeViewIcon'] = $this->treeViewIcon;
            }
    ...
    protected function normalizeItems($items, &$active)
    {
        foreach ($items as $i => $item) {
            ...
            if (isset($item['badge'])) {
                ...
                if ( ! isset($item['badge']['type'])) {
                    $item['badge']['type'] = 'primary';
                }
                if ( ! isset($item['badge']['align'])) {
                    $item['badge']['align'] = 'right';
                }
